#include "squarets/core/errors/errors.hpp" // IWYU pragma: associated

OUTCOME_CPP_DEFINE_CATEGORY(squarets::core::errors, GeneratorError, e) {
  using squarets::core::errors::GeneratorError;
  switch (e) {
