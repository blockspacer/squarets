...
class squarets_conan_project(conan_build_helper.CMakePackage):
    ...
    description = "squarets: C++ compile-time programming (serialization, reflection, code modification, enum to string, better enum, enum to json, extend or parse language, etc.)."
    topics = ('c++')
    ...
    def package_info(self):
        ...
        #  os.path.join("base", "third_party", "squarets"))
        #self.cpp_info.includedirs.append(
        #  os.path.join("base", "third_party", "squarets", "compat"))
